Here's the rearranged **Input and expected output.md** file organized by user role:

```markdown
# Input and Output Scenarios - Organized by User Role

## ADMINISTRATOR SCENARIOS

### **1. Administrator: Managing Flights - Adding New Flight**
...
### **2. Administrator: Assigning Crew to a Flight**
...
### **3. Administrator: Generating a Flight Performance Report**
...
## BOOKING AGENT SCENARIOS

### **4. Booking Agent: Booking a Flight for a Passenger**
...
### **5. Booking Agent: Canceling a Reservation and Processing Refund**
...
### **7. Passenger: Searching and Booking a Flight**
...
### **8. Passenger: Viewing Reservations**
...
### **9. Passenger: Checking In for a Flight**
...
This document is now organized by user role:
- **Administrator** (Scenarios 1-3): Flight management, crew assignment, reports
- **Booking Agent** (Scenarios 4-6): Flight booking, cancellations, error handling
- **Passenger** (Scenarios 7-10): Search/book flights, view reservations, check-in, error handling
```